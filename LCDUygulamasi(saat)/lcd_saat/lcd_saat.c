 ...
 * lcd_saat.c
 *
 *  Created on: 15 Kasım 2024
 *      Author: Abdullah ÇALLIOĞLU
 */
#include <stdint.h>
#include <stdbool.h>
...
void baslangic(void)   //LCD başlangıç ayarlarını yapar.
{
    ...
    LCD_sil();
        ...
        komut_yaz(0x06);//kursörü sağa kaydır
...
{
    int a;
    a=GPIOIntStatus(GPIO_PORTF_BASE,true);  // hangi pinden kesme geldiğini gösteriyor
